...
class Autoencoder(nn.Module):
    ...
    def forward(self, x):
       ...
       conv_b6 = F.relu(self.batchNorm6(self.conv_6(conv_b5)))
        ...
        #Decoupling 
       conv_b6_vis = self.weight0_vis(conv_b6)
       conv_b5_vis = self.weight1_vis(conv_b5) 
       conv_b3_vis = self.weight2_vis(conv_b3)
       conv_b2_vis = self.weight3_vis(conv_b2)
       conv_b1_vis = self.weight4_vis(conv_b1)
